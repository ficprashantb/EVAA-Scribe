...
GlobalVariable.EVAA_SC_NO = 'EVAA_SCRIBE_TC_U12'
...
CustomKeywords.'steps.EVAASteps.UploadReRecordDictation'(RecordFilePath, FirstName, LastName, DOB, Provider_FirstName, Provider_LastName)
